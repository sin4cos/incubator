...
#define WINDOW_TITLE "camera move example"
...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        view = glm::lookAt(camera_pos,                  // 摄像机额位置坐标
                           camera_pos + camera_front,   // 摄像机所指向的目标的位置坐标
                           camera_up);                  // 摄像机的上向量（本示例的摄像机的上向量正好是 y 轴的正方向）
